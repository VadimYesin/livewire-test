<div class="p-5 bg-gray-800">
    @if($unit)
        <div id="delete" tabindex="-1" role="dialog" aria-labelledby="deleteLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form wire:submit="submit">
                        <h5 class="text-white font-bold my-2">Are you sure want to delete {{ $unit->title }} unit?</h5>
